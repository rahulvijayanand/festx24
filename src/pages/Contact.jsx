    ...
    <div>
      ...
      <div className="min-h-screen bg-cover bg-center bg-no-repeat items-center justify-center">
        <div className="body3 w-full flex items-center justify-center">
          <div className="texthead text-9xl tracking-[0.20em] text-left w-full pl-14">
            Contact Us
          </div>
        </div>
      </div>
      ...
      {/* Subheading */}
      <div className="text-center text-5xl mt-12 texttitle">
        Student Coordinators
      </div>

      {/* Image below the subheading */}
      <div className="flex items-center justify-center mt-4">
        <img src={borderImage} alt="Border" className="max-w-[400px] h-auto" />
      </div>
